...
### DeepSeek-V4 峰谷定价说明（2026-08-17 生效，2026-08-23 起周末全天谷底价）

DeepSeek-V4 系列采用**分时计价**（来源：[DeepSeek 官方调价公告](https://news.qq.com/rain/a/20260817V03S1500)、
[新浪财经](https://finance.sina.cn/2026-08-17/detail-ininqpez7895655.d.html?vt=4)）：

- **工作日（周一至周五）**：每日 9:00–14:00 为高峰时段，其余为空闲（低谷）时段，
  高峰价格是空闲的 **2 倍**。
- **周末（周六、周日）**：全天**不区分峰谷**，统一按**空闲（低谷）时段价格**计费
  （[DeepSeek 再调价：周末不再分峰谷时段](https://finance.sina.cn/2026-08-23/detail-inipiiqm0423408.d.html)、
  [周末 API 改为全天低谷价](http://www.iheima.com/article-400996.html)）。

| 模型 | 时段 | 输入(缓存未命中) | 输入(缓存命中) | 输出 |
|---|---|---|---|---|
| deepseek-v4-flash | 空闲 / 周末全天 | ¥1.5 | ¥0.05 | ¥4.5 |
| deepseek-v4-flash | 工作日高峰 9:00–14:00 | ¥3.0 | ¥0.10 | ¥9.0 |
| deepseek-v4-pro | 空闲 / 周末全天 | ¥4.5 | ¥0.15 | ¥13.5 |
| deepseek-v4-pro | 工作日高峰 9:00–14:00 | ¥9.0 | ¥0.30 | ¥27.0 |
